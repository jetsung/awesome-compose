...
> [New-API][1] 是新一代 AI 基座平台，为您的 AI 应用提供统一的基础设施。承载所有 AI 应用，管理您的数字资产，连接未来的统一接口平台。
...
[1]:https://www.newapi.ai/
[2]:https://github.com/QuantumNous/new-api
[3]:https://hub.docker.com/r/calciumion/new-api
[4]:https://www.newapi.ai/zh/docs/installation/deployment-methods/docker-compose-installation
...
| 环境变量                         | 说明                              | 默认值     | 示例                                   |
| ---------------------------- | ------------------------------- | ------- | ------------------------------------ |
| `FORCE_STREAM_OPTION`        | 覆盖客户端stream\_options参数          | `true`  | `FORCE_STREAM_OPTION=false`          |
